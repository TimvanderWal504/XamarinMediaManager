...
{
    public class PlaybackManager : PlaybackCallback
    {
        // Action to thumbs up a media item
        private static string CUSTOM_ACTION_THUMBS_UP = "com.example.android.uamp.THUMBS_UP";
        ...
        public PlaybackManager(PlaybackServiceCallback serviceCallback, Resources resources, 
                               MusicProvider musicProvider, QueueManager queueManager, Playback playback)
        {
        ...
        public override void onPlaybackStatusChanged(int state)
        {
